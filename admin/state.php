...
{
	$School=$_POST['School'];
	$Schooldescription=$_POST['Schooldescription'];
$sql=mysqli_query($con,"insert into School(SchoolName,SchoolDescription) values('$School','$description')");
...
<head>
	...
	<title>Complaint manager| School</title>
...
<div class="controls">
<input type="text" placeholder="Enter School Name"  name="School" class="span8 tip" required>
</div>
</div>
...
?>
										<tr>
											...
											<td><?php echo htmlentities($row['SchoolName']);?></td>
											<td><?php echo htmlentities($row['SchoolDescription']);?></td>
