...
<?php include('includes/sidebar.php');?>
 ...
 <?php $query=mysqli_query($con,"select tblcomplaints.*,department.departmentName as catname from tblcomplaints join department on department.id=tblcomplaints.category where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
